...
public class RU_Bookings_List_ViewController: RU_ViewController {
            ...
            if !isEditing {
                ...
                RU_Classified.getAll { [weak self] error, classifieds in
                    ...
                    if !children.isEmpty {
                        ...
                        let filterBarButtonItem:UIBarButtonItem = .init(title: buttonTitle, menu: .init(title: String(key: "bookings.filter.menu.title"), children: children))
                        self?.navigationItem.rightBarButtonItems?.append(filterBarButtonItem)
                    }
                }
...
extension RU_Bookings_List_ViewController: UITableViewDelegate, UITableViewDataSource {
